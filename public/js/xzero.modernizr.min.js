...
var ModernizrExtends = {
  libsToLoad: [],

  start: function(finalLoad, callback) {
    // Add libs of parent
    //var finalLoad = ModernizrExtends.libsToLoad.concat(addToLibs);

    // Load libs
    Modernizr.load([{
      load: finalLoad,
      complete: function() {
        // Set jQuery as noconflict
        $.noConflict();
...
var spriteHandler = {
    ...
    animationContainer: [],
    animationStart: function(selectorUI, options, nativeMode) {
        if(typeof nativeMode != 'undefined' && nativeMode === true) {
            spriteHandler.animationContainer[selectorUI] = new Motio(document.getElementById(selectorUI), options);
        } else {
            // jQuery mode
    ...
    startSpinner: function() {
        console.log('startspinner handled');
        spriteHandler.animationStart('spinnerLoad', {
            fps: 11,
            frames: 12,
            vertical: 1,
            reverse: false
